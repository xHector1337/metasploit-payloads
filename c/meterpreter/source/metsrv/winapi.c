...
/*
;Muzaffer Umut Şahin <mailatmayinlutfen@gmail.com>

.code

public ArraySyscall

;NTSTATUS ArraySyscall(void* pFunction, unsigned int ParamCount, unsigned __int64* pParameters);

ArraySyscall proc
 ; It is the caller's responsibility not to pass NULL as pFunction.
 pop r10
 cmp byte ptr [rcx+3], 0B8h
 jne exit
 mov eax, dword ptr [rcx+4]

find_syscall:
 cmp word ptr [rcx],050fh
 je parse_args
 inc rcx
...
parse_args:
 xchg r10,rbx ; rbx now stores the return address
 cmp rdx, 1
 jl exec
 test r8,r8
 jz exec
...
BYTE ArraySyscall64[] = { 0x41,0x5a,0x80,0x79,0x03,0xb8,0x75,0x66,0x8b,0x41,0x04,0x66,0x81,0x39,0x0f,0x05,0x74,0x08,0x48,0xff,0xc1,0x80,0x39,0xc3,0x75,0xf1,0x4c,0x87,0xd3,0x48,0x83,0xfa,0x01,0x7c,0x44,0x4d,0x85,0xc0,0x74,0x3f,0x4d,0x8b,0x10,0x48,0x83,0xfa,0x02,0x7c,0x36,0x4c,0x87,0xda,0x49,0x8b,0x50,0x08,0x49,0x83,0xfb,0x03,0x7c,0x29,0x4d,0x87,0xc4,0x4d,0x8b,0x44,0x24,0x10,0x49,0x83,0xfb,0x04,0x7c,0x1b,0x4d,0x8b,0x4c,0x24,0x18,0x49,0x83,0xc4,0x18,0x49,0x83,0xeb,0x04,0x4d,0x85,0xdb,0x74,0x09,0x43,0xff,0x34,0xdc,0x49,0xff,0xcb,0xeb,0xf2,0x48,0x83,0xec,0x20,0x53,0xff,0xe1,0x41,0xff,0xe2};
